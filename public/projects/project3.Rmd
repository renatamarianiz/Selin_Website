...
```{r table of avg gross and budget, warning=FALSE, message=FALSE}
...
```{r revenue, warning=FALSE, message=FALSE}
...
```{r rating, warning=FALSE, message=FALSE}
...
```{r, gross_on_cast_facebook_likes, warning=FALSE, message=FALSE}
